    ...
    <nav className="p-4 bg-background/50 sticky top-0  backdrop-blur border-b z-50">
      <div className="container mx-auto flex justify-between items-center">
        <div className="text-lg font-bold">
          <Link href="/">ClothCycle</Link>
        </div>
        <div className="hidden md:flex space-x-4 items-center">
          <Link href="/" className="hover:scale-105 hover:font-semibold transition-transform duration-300">
            Home
          </Link>
          <Link href="/Clothes Donation" className="hover:scale-105 hover:font-semibold transition-transform duration-300">
          Clothes Donation
          </Link>
          <Link href="/Clothes Disposal" className="hover:scale-105 hover:font-semibold transition-transform duration-300">
          Clothes Disposal
          </Link>
          <Link href="/Donation Tracking" className="hover:scale-105 hover:font-semibold transition-transform duration-300">
          Donation Tracking
          </Link>
        ...
        <div className="md:hidden">
          ...
          <span className="mx-2">
            ...
            <SheetContent>
              <SheetHeader>
                <SheetTitle className="font-bold"> FaisalBlog</SheetTitle>
                <SheetDescription>
