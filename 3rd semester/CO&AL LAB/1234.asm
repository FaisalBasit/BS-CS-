...
DIVIDE DB 0DH, 0AH, 'THE RESULT OF DIVISION IS = $'  
REMAINDER DB 0DH, 0AH, 'REMAINDER = $' 
...
INPNMBR PROC
    ...
    INT 21H                              ; Call DOS interrupt
    MOV BL,AL                        ; Move the input to BL
...
;DIVISION:
    LEA DX,DIVIDE            ; Load effective address of the result message to DX
    MOV AH,9                       ; DOS function to display a string
    INT 21H                      ; Call DOS interrupt 
